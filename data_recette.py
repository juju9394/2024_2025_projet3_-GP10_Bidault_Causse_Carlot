...
recettes = [
    {
        ...
        "etapes": [
            ...
            "Dans une poêle chaude, verser l'huile d'olive et saisir rapidement le filet mignon pour le colorer.",
            "Réserver la viande et laisser refroidir.",
            "Nettoyer et hacher champignons, échalotes et ail.",
            "Faire revenir échalotes, puis champignons, ail et persil.",
            "Laisser refroidir la préparation.",
            "Préchauffer le four à 200°C.",
            "Étaler la pâte feuilletée et disposer les tranches de jambon.",
            "Étaler la moutarde sur le filet mignon, ajouter les champignons, enrouler dans le jambon, puis dans la pâte.",
            "Badigeonner de jaune d'œuf.",
            "Enfourner 25-30 minutes jusqu'à doré.",
    ...
    },
    {
        ...
        "etapes": [
            ...
            "Parsemer d'ail émincé, thym et romarin.",
            "Arroser de jus de citron et disposer les rondelles.",
    ...
    },
    {
        ...
        "etapes": [
            "Préchauffer le four à 180°C.",
            "Mélanger huile, herbes, ail, jus de citron, sel et poivre.",
            "Badigeonner les blancs de poulet.",
            "Placer dans un plat et enfourner 25-30 minutes en retournant à mi-cuisson.",
            "Vérifier la cuisson (jus clair).",
    ...
    },
    {
        ...
        "etapes": [
            ...
            "Égoutter les pâtes et mélanger rapidement avec les lardons et la sauce.",
            "Servir chaud."
        ]
    },
    {
        ...
        "etapes": [
            ...
            "Cuire les œufs durs, puis les couper.",
            "Égoutter le thon et le maïs.",
            "Couper les tomates en dés.",
            "Mélanger tous les ingrédients, ajouter la vinaigrette et servir frais."
        ]
    },
    {
    ...
    },
    {
        ...
        "etapes": [
            "Préchauffer le four à 200°C.",
            "Tartiner légèrement les tranches de pain avec de la béchamel.",
            "Déposer une tranche de jambon et du gruyère râpé.",
            "Refermer avec une autre tranche de pain.",
            "Étaler un peu de beurre sur le dessus.",
            "Enfourner pendant 10 minutes jusqu'à doré."
        ]
    },
    {
        ...
        "etapes": [
            ...
            "Faire revenir légèrement les légumes dans une grande casserole.",
            "Ajouter le bouillon chaud.",
            "Laisser mijoter 30 minutes.",
            "Mixer la soupe selon la texture désirée.",
